...
export const fieldOrder = {
  input: [],
  output: ['type', 'title', 'date', 'body', 'user', 'pull', 'comments'],
};
...
__ = {
  ...
  /**
   * Gets the count of comments for a specific pull request
   * @param {number} pullNumber - The pull request number to get comment count for
   * @returns {Promise<number>} The number of comments for the pull request
   */
  async getCommentCount(pullNumber) {
    const commentsPath = await glob(`./**/${pullNumber}.json`, {
