 ...
 * @param {Function} callback - Function to execute for each comment, receives an object with filepath, data, index, max properties
 ...
 * @param {string} commentsFilePath - The filepath to the comments.json file
 * @returns {Promise<object>} Normalized comment object with id, user, body, date, reactions, and sentiment
 */
export async function normalizeComment(inputComment, commentsFilePath) {
